...
const routes: Routes = [
  ...
  { path: 'error', component: ErrorPageComponent },
  {
    ...
    children: [
      ...
      { path: 'accounts/payment', component: ReceiptComponent },
      { path: 'accounts/payment/create', component: ReceiptComponent },
      { path: 'accounts/payment/edit/:id', component: ReceiptComponent },
      { path: 'accounts/receipt', component: PaymentComponent },
      { path: 'accounts/receipt/create', component: PaymentComponent },
      { path: 'accounts/receipt/edit/:id', component: PaymentComponent },
